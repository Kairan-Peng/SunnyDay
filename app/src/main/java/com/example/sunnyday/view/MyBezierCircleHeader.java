package com.example.sunnyday.view;
...
public class MyBezierCircleHeader extends View implements RefreshHeader {
    ...
    public MyBezierCircleHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public MyBezierCircleHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mBackPaint.setColor(0x66000000);
        mBackPaint.setAntiAlias(true);
        mFrontPaint = new Paint();
        mFrontPaint.setColor(0x99ffffff);
        mFrontPaint.setAntiAlias(true);
        mOuterPaint = new Paint();
        mOuterPaint.setAntiAlias(true);
        mOuterPaint.setColor(0xaaffffff);
    ...
    public void onRefreshReleased(RefreshLayout layout, int headerHeight, int extendHeight) {
        ...
        waveAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                MyBezierCircleHeader.this.invalidate();
            }
        });
